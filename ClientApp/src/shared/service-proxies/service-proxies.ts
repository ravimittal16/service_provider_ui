...
export class CustomFieldsServiceProxy {
     ...
     * @return Success
     */
    addUpdateCustomField(body: CustomFieldDefinationModel | undefined): Observable<CustomFieldDtoGenericResponse> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<CustomFieldDtoGenericResponse>><any>_observableThrow(e);
                }
            } else
                return <Observable<CustomFieldDtoGenericResponse>><any>_observableThrow(response_);
        }));
    }

    protected processAddUpdateCustomField(response: HttpResponseBase): Observable<CustomFieldDtoGenericResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = CustomFieldDtoGenericResponse.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<CustomFieldDtoGenericResponse>(<any>null);
    }
     ...
     * @return Success
     */
    getAllCustomFieldDefinations(entityType: number | undefined): Observable<CustomFieldDto[]> {
        let url_ = this.baseUrl + "/api/customFields/GetAllCustomFieldDefinations?";
        if (entityType === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllCustomFieldDefinations(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllCustomFieldDefinations(<any>response_);
                } catch (e) {
                    return <Observable<CustomFieldDto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<CustomFieldDto[]>><any>_observableThrow(response_);
        }));
    }

    protected processGetAllCustomFieldDefinations(response: HttpResponseBase): Observable<CustomFieldDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200.push(CustomFieldDto.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
        ...
        return _observableOf<CustomFieldDto[]>(<any>null);
    }
...
export class CustompricingServiceProxy {
     ...
     * @return Success
     */
    addUpdatePricingGroup(body: PricingGroupModel | undefined): Observable<PricingGroupDtoGenericResponse> {
        let url_ = this.baseUrl + "/api/custompricing/AddUpdatePricingGroup";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processAddUpdatePricingGroup(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processAddUpdatePricingGroup(<any>response_);
                } catch (e) {
                    return <Observable<PricingGroupDtoGenericResponse>><any>_observableThrow(e);
                }
            } else
                return <Observable<PricingGroupDtoGenericResponse>><any>_observableThrow(response_);
        }));
    }

    protected processAddUpdatePricingGroup(response: HttpResponseBase): Observable<PricingGroupDtoGenericResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PricingGroupDtoGenericResponse.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PricingGroupDtoGenericResponse>(<any>null);
    }

    /**
     * @return Success
     */
    allPricingGroups(): Observable<PricingGroupDto[]> {
        let url_ = this.baseUrl + "/api/custompricing/AllPricingGroups";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processAllPricingGroups(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processAllPricingGroups(<any>response_);
                } catch (e) {
                    return <Observable<PricingGroupDto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<PricingGroupDto[]>><any>_observableThrow(response_);
        }));
    }

    protected processAllPricingGroups(response: HttpResponseBase): Observable<PricingGroupDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200.push(PricingGroupDto.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
...
export class CustomFieldDto implements ICustomFieldDto {
    ...
    defaultValue2: string | undefined;
    valueType: string | undefined;
    customFieldTypeId: number | undefined;
    fieldName: string | undefined;
    isCustomType: boolean | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.defaultValue2 = _data["defaultValue2"];
            this.valueType = _data["valueType"];
            this.customFieldTypeId = _data["customFieldTypeId"];
            this.fieldName = _data["fieldName"];
            this.isCustomType = _data["isCustomType"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["defaultValue2"] = this.defaultValue2;
        data["valueType"] = this.valueType;
        data["customFieldTypeId"] = this.customFieldTypeId;
        data["fieldName"] = this.fieldName;
        data["isCustomType"] = this.isCustomType;
        return data; 
    }
...
export class CustomFieldDtoGenericResponse implements ICustomFieldDtoGenericResponse {
    httpStatusCode: number;
    readonly hasError: boolean;
    isSuccess: boolean;
    entity: CustomFieldDto;
    errors: string[] | undefined;
    errorType: ErrorTypes;
    actionReturnCode: ActionReturnCode;

    constructor(data?: ICustomFieldDtoGenericResponse) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            (<any>this).hasError = _data["hasError"];
            this.isSuccess = _data["isSuccess"];
            this.entity = _data["entity"] ? CustomFieldDto.fromJS(_data["entity"]) : <any>undefined;
            if (Array.isArray(_data["errors"])) {
                this.errors = [] as any;
                for (let item of _data["errors"])
                    this.errors.push(item);
    ...
    static fromJS(data: any): CustomFieldDtoGenericResponse {
        data = typeof data === 'object' ? data : {};
        let result = new CustomFieldDtoGenericResponse();
        result.init(data);
        return result;
    }
    ...
    clone(): CustomFieldDtoGenericResponse {
        const json = this.toJSON();
        let result = new CustomFieldDtoGenericResponse();
        result.init(json);
        return result;
...
export interface ICustomFieldDtoGenericResponse {
    httpStatusCode: number;
    hasError: boolean;
    isSuccess: boolean;
    entity: CustomFieldDto;
...
export class PricingGroupModel implements IPricingGroupModel {
    pricingGroupId: number;
    groupName: string | undefined;

    constructor(data?: IPricingGroupModel) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): PricingGroupModel {
        data = typeof data === 'object' ? data : {};
        let result = new PricingGroupModel();
        result.init(data);
        return result;
    }
...
export class PricingGroupDto implements IPricingGroupDto {
    pricingGroupId: number;
    groupName: string | undefined;
    createdByName: string | undefined;
    createdById: string | undefined;
    ...
    constructor(data?: IPricingGroupDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): PricingGroupDto {
        data = typeof data === 'object' ? data : {};
        let result = new PricingGroupDto();
        result.init(data);
        return result;
    }
...
export interface IPricingGroupDto {
    pricingGroupId: number;
    groupName: string | undefined;
    createdByName: string | undefined;
    createdById: string | undefined;
...
export class PricingGroupDtoGenericResponse implements IPricingGroupDtoGenericResponse {
    httpStatusCode: number;
    readonly hasError: boolean;
    isSuccess: boolean;
    ...
    constructor(data?: IPricingGroupDtoGenericResponse) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            (<any>this).hasError = _data["hasError"];
            this.isSuccess = _data["isSuccess"];
            this.entity = _data["entity"] ? PricingGroupDto.fromJS(_data["entity"]) : <any>undefined;
            if (Array.isArray(_data["errors"])) {
                this.errors = [] as any;
                for (let item of _data["errors"])
                    this.errors.push(item);
    ...
    static fromJS(data: any): PricingGroupDtoGenericResponse {
        data = typeof data === 'object' ? data : {};
        let result = new PricingGroupDtoGenericResponse();
        result.init(data);
        return result;
    }
    ...
    clone(): PricingGroupDtoGenericResponse {
        const json = this.toJSON();
        let result = new PricingGroupDtoGenericResponse();
        result.init(json);
        return result;
...
export interface IPricingGroupDtoGenericResponse {
    httpStatusCode: number;
    hasError: boolean;
    isSuccess: boolean;
    entity: PricingGroupDto;
